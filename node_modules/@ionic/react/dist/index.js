...
const ReactDelegate = (addView, removeView) => {
    ...
    const attachViewToDom = async (parentElement, component, propsOrDataObj, cssClasses) => {
        ...
        Component = ReactDOM.createPortal(component(), div);
...
const IonNav = (_a) => {
    var restOfProps = tslib.__rest(_a, ["children"]);
    ...
    return (React__default["default"].createElement(IonNavInner, Object.assign({ delegate: delegate }, restOfProps), views));
};
